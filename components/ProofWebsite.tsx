    ...
    <div style={{ position: "relative", width: size, height: size }}>
      ...
      <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
        <circle
          ...
          strokeWidth="2"
          fill={fired ? COLORS.signalDim : "transparent"}
        ...
        <path
          ...
          style={{
            ...
            transition:
              "stroke-dashoffset 0.5s ease 0.3s, stroke 0.4s ease",
          }}
        />
      </svg>
    </div>
  ...
  >
    ...
    <div
      style={{
        width: 40,
        height: 2,
        background: highlight ? COLORS.signal : COLORS.surfaceBorder,
        marginBottom: 28,
      }}
    />
    <div
    ...
    >
      {features.map((f, i) => (
        <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
          <span
            style={{
              color: highlight ? COLORS.signal : COLORS.subtle,
              fontSize: 14,
              lineHeight: "22px",
              flexShrink: 0,
            }}
    ...
    <button
      ...
      onMouseOver={(e) => {
        if (!highlight) {
          (e.target as HTMLButtonElement).style.borderColor = COLORS.signal;
          (e.target as HTMLButtonElement).style.color = COLORS.signal;
        }
      }}
      onMouseOut={(e) => {
        if (!highlight) {
          (e.target as HTMLButtonElement).style.borderColor = COLORS.surfaceBorder;
...
const UnitPill = ({ text }: { text: string }) => (
  <span
    style={{
    ...
    onMouseOver={(e) => {
      (e.target as HTMLSpanElement).style.borderColor = COLORS.signal;
      (e.target as HTMLSpanElement).style.color = COLORS.signal;
    }}
    onMouseOut={(e) => {
      (e.target as HTMLSpanElement).style.borderColor = COLORS.surfaceBorder;
      (e.target as HTMLSpanElement).style.color = COLORS.subtle;
    }}
  >
    {text}
  </span>
  ...
  return (
    ...
    >
          ...
          <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
            {["How it works", "Pricing", "For brands"].map((item, i) => (
              <a
                ...
                onMouseOver={(e) =>
                  ((e.target as HTMLAnchorElement).style.color = COLORS.textBright)
                }
                onMouseOut={(e) =>
                  ((e.target as HTMLAnchorElement).style.color = COLORS.subtle)
                }
              >
                {item}
              </a>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              style={{
                color: verified ? COLORS.signal : COLORS.muted,
          ...
          >
            ...
            reward real athletic effort instead of just transactions. The Stripe
            of athletic loyalty.
          </p>
          <div
            style={{
        ...
        <Section>
          ...
          >
            <div style={{ flex: "1 1 400px", maxWidth: 500 }}>
              ...
              >
                PROOF Verified Effort is a universal trust mark that confirms
                real athletic activity — verified through GPS, heart rate, and
                platform APIs. It works across every sport, every unit, every
                brand.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {["Miles", "Meters", "Rounds", "Sessions", "Watts", "Laps", "Reps", "Hours"].map(
                  (u) => <UnitPill key={u} text={u} />
                )}
              </div>
            </div>
            <div
      ...
      <Section id="how-it-works">
        ...
        >
          <div style={{ flex: "1 1 350px" }}>
            ...
            >
              PROOF sits between your customers&apos; fitness platforms and your
              loyalty engine. One integration, every sport.
            </p>
          </div>
        ...
        <Section style={{ padding: "80px 24px" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: COLORS.muted }}>:</span>{" "}
              <span style={{ color: COLORS.signal }}>
                &apos;https://you.com/api/proof&apos;
              </span>
              {"\n"}
              <span style={{ color: COLORS.muted }}>{"})"}</span>
              {"\n\n"}
              <span style={{ color: COLORS.muted }}>
                {"// Verified activity lands here"}
              </span>
              {"\n"}
      ...
      <Section id="for-brands">
        ...
        >
          {[
            {
              icon: "◎",
              title: "Endorsed model",
              desc: "Like Intel Inside — our badge sits discreetly in your experience. Customers see your brand first, PROOF verification second.",
            },
            {
              icon: "⬡",
              title: "Any sport, any unit",
              desc: "Miles, meters, watts, rounds, sessions. You define what effort means for your customers. PROOF verifies it.",
            },
            {
              icon: "⚡",
              title: "Fraud prevention",
              desc: "GPS validation, velocity checks, anomaly detection. We catch fake activities so your loyalty budget goes to real athletes.",
            },
            {
              icon: "↗",
              title: "Engagement lift",
              desc: "Brands using effort-based loyalty see 3.2× higher program engagement vs. spend-only programs.",
            },
            {
              icon: "⟁",
              title: "30+ integrations",
              desc: "Strava, Garmin, Apple Health, Peloton, Whoop, Zwift, and growing. One SDK, every platform.",
            },
            {
              icon: "◈",
              title: "Your stack, untouched",
              desc: "PROOF plugs into LoyaltyLion, Yotpo, Smile.io, Shopify, Klaviyo — or your custom system via webhooks.",
            },
          ].map((item, i) => (
            <div
              key={i}
      ...
      <div style={{ borderTop: `1px solid ${COLORS.surfaceBorder}` }}>
        <Section id="pricing">
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            ...
            >
              No setup fees. No per-transaction cuts. Flat monthly pricing that
          ...
          >
            <PricingCard
              ...
              features={[
                ...
                "3 fitness platform integrations",
      ...
      >
        <Section
          id="waitlist"
          style={{ textAlign: "center", padding: "120px 24px 100px" }}
        >
          ...
          >
            We&apos;re onboarding the first 50 brands now. Request early access
            and we&apos;ll set up a 15-minute walkthrough of the platform.
          </p>
            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    padding: "14px 28px",
                    background: formState === "loading" ? COLORS.muted : COLORS.signal,
                    border: "none",
                    fontFamily: "'Syne', sans-serif",
                    fontSize: 12,
                    fontWeight: 700,
          ...
          <div style={{ display: "flex", gap: 24 }}>
            {["Privacy", "Terms", "Documentation", "Status"].map((link, i) => (
              <a
                ...
                onMouseOut={(e) =>
                  ((e.target as HTMLAnchorElement).style.color = COLORS.muted)
                }
              >
                {link}
              </a>
